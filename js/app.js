...
let sliderTeam = new Swiper('.team__slider', {
...
let sliderSertificst = new Swiper('.sertificat__slider', {
	...
	// Arrows
	navigation: {
		nextEl: '.sertificat__arrow-right',
		prevEl: '.sertificat__arrow-left',
	},
...
if (menuBtn != null) {
	let delay = 500;
	let menuSublist = document.querySelector(".menu__sublist");
...
let inputsFile = document.querySelectorAll('.input__file');
